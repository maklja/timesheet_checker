...
public class ChargeHoursAction {
    ...
    public void execute(final ChargeHoursActionPayload payload) {
        ...
        try (final var playwright = Playwright.create();
            ...
            chargeHoursAction(payload, page);
            LOGGER.info("Hours charge completed successfully");
        }
    }

    private static void chargeHoursAction(final ChargeHoursActionPayload payload, final Page page) {
